...
#define LOGI(...) __android_log_print(ANDROID_LOG_INFO,"Easyhood",__VA_ARGS__)
extern "C"{
...
Java_com_easyhood_easyrtmpbilibili_ScreenLive_connect(JNIEnv *env, jobject thiz, jstring url_) {
...
JNIEXPORT jboolean JNICALL
Java_com_easyhood_easyrtmpbilibili_ScreenLive_sendData(JNIEnv *env, jobject thiz, jbyteArray data_, jint len,
                                              jlong tms) {
    int ret;
